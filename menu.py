...
#  \version 1.0.3
#
#  EDITS - Andrew 05/03/2016: Added lines to make buttons transparent - this is probably done wrong!
#
...
class cMenu:
   ...
   def __init__(self, x, y, h_pad, v_pad, orientation, number, background,
      ...
      self.font = pygame.font.Font('./fonts/Capture_it.ttf', int(fontsize))    # Font to use
